  ...
  Widget build(BuildContext context) {
    return SettingItemWidget(
      leading: ic_notification.iconImage(
          size: appStore.userType == USER_TYPE_PROVIDER ? 16 : 18),
      title: languages.pushNotification,
      titleTextStyle: appStore.userType == USER_TYPE_PROVIDER
          ? boldTextStyle(size: 12)
          : primaryTextStyle(),
      padding:
          appStore.userType == USER_TYPE_PROVIDER ? null : EdgeInsets.all(16),
      decoration: appStore.userType == USER_TYPE_PROVIDER
